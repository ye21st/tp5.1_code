<?php /*a:3:{s:53:"F:\www\TP5.1\2.0\application/index/view\cate\add.html";i:1516758380;s:58:"F:\www\TP5.1\2.0\application/index/view\common\header.html";i:1516697315;s:58:"F:\www\TP5.1\2.0\application/index/view\common\footer.html";i:1516694288;}*/ ?>
<!DOCTYPE html>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-green-haze">
                                    ...
                                    <span class="caption-subject bold uppercase"> 添加栏目</span>
                                </div>
                            </div>
                                ...
                                <form action="" method="post" role="form" class="form-horizontal">
                                    <div class="form-body">
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <select name="pid" class="form-control" id="pid">
                                                    ...
                                                    <option value="<?php echo htmlentities($cate['id']); ?>"><?php if($cate['level'] != 0): ?>|<?php endif; ?><?php echo str_repeat('-', $cate['level']*4)?><?php echo htmlentities($cate['catename']); ?></option>
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input name="catename" type="text" class="form-control" id="catename" placeholder="输入你的栏目名称">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                    </div>
