<?php /*a:3:{s:54:"F:\www\TP5.1\2.0\application/index/view\cate\edit.html";i:1516720962;s:58:"F:\www\TP5.1\2.0\application/index/view\common\header.html";i:1516697315;s:58:"F:\www\TP5.1\2.0\application/index/view\common\footer.html";i:1516694288;}*/ ?>
<!DOCTYPE html>
                ...
                <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                    ...
                    <li class="nav-item  active open">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo url('index/cate/index'); ?>" class="nav-link ">
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo url('index/cate/lst'); ?>">栏目管理</a>
                            <i class="fa fa-circle"></i>
                        </li>
                        <li>
                            <a>修改栏目</a>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-green-haze">
                                    ...
                                    <span class="caption-subject bold uppercase"> 修改栏目</span>
                                </div>
                            </div>
                            <div class="portlet-body form">
                                <form action="" method="post" role="form" class="form-horizontal">
                                    <input type="hidden" name="id" value="<?php echo htmlentities($cates['id']); ?>" />
                                    <div class="form-body">
                                        <div class="form-group form-md-line-input">
                                            <label class="col-md-2 control-label" for="pid">上级栏目</label>
                                            <div class="col-md-10">
                                                <select name="pid" class="form-control" id="pid">
                                                    <option value="0">顶级栏目</option>
                                                    <?php if(is_array($cateres) || $cateres instanceof \think\Collection || $cateres instanceof \think\Paginator): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>
                                                    <option <?php if($cates['pid'] == $cate['id']): ?>selected="selected"<?php endif; ?> value="<?php echo htmlentities($cate['id']); ?>"><?php if($cate['level'] != 0): ?>|<?php endif; ?><?php echo str_repeat('-', $cate['level']*4)?><?php echo htmlentities($cate['catename']); ?></option>
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input name="catename" type="text" class="form-control" id="catename" placeholder="输入你的栏目名称" value="<?php echo htmlentities($cates['catename']); ?>">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                    </div>
