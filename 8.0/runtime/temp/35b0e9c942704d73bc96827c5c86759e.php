<?php /*a:3:{s:57:"F:\www\TP5.1\8.0\application/index/view\article\info.html";i:1519899847;s:58:"F:\www\TP5.1\8.0\application/index/view\common\header.html";i:1520746664;s:58:"F:\www\TP5.1\8.0\application/index/view\common\footer.html";i:1516949997;}*/ ?>
<!DOCTYPE html>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-green">
                                    ...
                                    <span class="caption-subject bold uppercase"> 文章详情页面</span>
                                </div>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group form-md-line-input form-md-floating-label">
                                                    <input type="text" class="form-control edited" name="title" id="title" value="<?php echo htmlentities($info['title']); ?>" disabled>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group form-md-line-input form-md-floating-label">
                                                    <input type="text" class="form-control edited" name="author" id="author" value="<?php echo htmlentities($info['author']); ?>" disabled>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group form-md-line-input form-md-floating-label">
                                                    <input type="text" class="form-control edited" name="sort" id="sort" value="<?php echo htmlentities($info['sort']); ?>" disabled>
