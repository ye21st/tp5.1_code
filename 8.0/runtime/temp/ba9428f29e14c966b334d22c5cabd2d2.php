<?php /*a:3:{s:56:"F:\www\TP5.1\8.0\application/index/view\article\add.html";i:1519887572;s:58:"F:\www\TP5.1\8.0\application/index/view\common\header.html";i:1520746664;s:58:"F:\www\TP5.1\8.0\application/index/view\common\footer.html";i:1516949997;}*/ ?>
<!DOCTYPE html>
                                ...
                                <form role="form" action="" method="post">
                                    <div class="form-body">
                                        <div class="form-group form-md-line-input form-md-floating-label">
                                            <input type="text" class="form-control edited" name="title" id="title" value="">
                                            <label for="title">文章标题</label>
                                            <span class="help-block"></span>
                                        </div>
                                        <div class="form-group form-md-line-input form-md-floating-label">
                                            <input type="text" class="form-control edited" name="author" id="author" value="">
                                        ...
                                        <div class="form-group form-md-line-input form-md-floating-label">
                                            <input type="text" class="form-control edited" name="sort" id="sort" value="">
